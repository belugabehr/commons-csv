...
public class ExtendedBufferedReaderTest {
    ...
    public void testEmptyInput() throws Exception {
        try (final ExtendedBufferedReader br = ExtendedBufferedReader.create("")) {
    ...
    public void testReadChar() throws Exception {
        ...
        try (final ExtendedBufferedReader br = ExtendedBufferedReader.create(test)) {
    ...
    public void testReadingInDifferentBuffer() throws Exception {
        ...
        try (ExtendedBufferedReader reader = ExtendedBufferedReader.create("1\r\n2\r\n")) {
    ...
    public void testReadLine() throws Exception {
        ...
        try (final ExtendedBufferedReader br = ExtendedBufferedReader.create("foo\n\nhello")) {
            assertEquals(0, br.getCurrentLineNumber());
        ...
        try (final ExtendedBufferedReader br = ExtendedBufferedReader.create("foo\rbaar\r\nfoo")) {
            assertEquals("foo", br.readLine());
    ...
    public void testReadLookahead1() throws Exception {
        try (final ExtendedBufferedReader br = ExtendedBufferedReader.create("1\n2\r3\n")) {
            assertEquals(0, br.getCurrentLineNumber());
    ...
    public void testReadLookahead2() throws Exception {
        ...
        try (final ExtendedBufferedReader br = ExtendedBufferedReader.create("abcdefg")) {
            ref[0] = 'a';
            ref[1] = 'b';
            ref[2] = 'c';
